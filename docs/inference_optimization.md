...
This document records the current unified runtime optimization for the subtitle detector.
...
Run Rust runtime validation with optimized artifact:

```bash
cargo run --release --bin infer -- \
  --model-json /Users/wei/Dev/python/subfast-net/outputs/full_512/unified_batch16_head/model.json \
  --model-bin /Users/wei/Dev/python/subfast-net/outputs/full_512/unified_batch16_head/weights.bin \
  --validation-root /Users/wei/Dev/python/subfast-net/data/validation_samples \
  --output-jsonl /tmp/subfast-net-validation-full512-batch16-head.jsonl
```

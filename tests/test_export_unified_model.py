...
from src.export_unified_model import export_pt2_to_unified_model
...
class UnifiedModelExportTests(unittest.TestCase):
    ...
    def test_export_cli_writes_unified_model_directory(self):
        from src.export_unified_model import main
    ...
    def test_export_checkpoint_to_coreml_saves_mlpackage(self):
        from src.export_unified_model import export_model_to_coreml_model

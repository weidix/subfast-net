...
from ..detector.dataset import IMAGENET_MEAN, IMAGENET_STD
from ..detector.geometry import Box, yolo_to_box
from .pairs import infer_adjacent_segment_ids, parse_frame_index, parse_video_frame_from_sample_id, parse_video_id
...
def collate_pair_batch(items: list[dict]) -> RoiPairBatch:

...
_ROUTES: dict[tuple[str, str], tuple[str, str]] = {
    # Training families.
    ("train", "detector"): ("subfast_net.detector.train", "main"),
    ("train", "presence"): ("subfast_net.roi.presence.train", "main"),
    ("train", "matcher"): ("subfast_net.roi.matcher.train", "main"),
    ("train", "embedding"): ("subfast_net.roi.embedding.train", "main"),
    # Validation and benchmarks.
    ("validate", "matcher"): ("subfast_net.roi.matcher.train", "main_validate"),
    ("validate", "embedding"): ("subfast_net.roi.embedding.train", "main_validate"),
    ("benchmark", "presence"): ("subfast_net.roi.presence.train", "main_benchmark"),
    # Export formats.
    ("export", "unified"): ("subfast_net.export.unified", "main"),
    ("export", "coreml"): ("subfast_net.export.unified", "main_coreml"),
    ("export", "safetensors"): ("subfast_net.export.safetensors", "main"),
}

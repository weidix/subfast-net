...
class FeatureCache:
    def __init__(self, directory: Path) -> None:
        ...
        supported_format = (
            self.meta.get("format") == H264_TIMING_FEATURE_FORMAT
            and self.meta.get("version") == H264_TIMING_FEATURE_VERSION
        ) or (
            self.meta.get("format") == FULL_FRAME_TIMING_FEATURE_FORMAT
            and self.meta.get("version") == FULL_FRAME_TIMING_FEATURE_VERSION
        )
        ...
        if visual_meta_path.exists():
            ...
            if (
                visual_meta.get("format") != H264_TIMING_VISUAL_FEATURE_FORMAT
                or visual_meta.get("version") != H264_TIMING_VISUAL_FEATURE_VERSION

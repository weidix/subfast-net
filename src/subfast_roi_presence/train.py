...
from subfast_roi_data.training import (
    format_dataset_summary as _format_dataset_summary,
    parse_roi_size,
    seed_everything,
    synchronize_device,
)
...
from .config import RoiPresenceTrainSettings
from .dataset import RoiPresenceDataset, collate_presence_batch
from .loss import (
...
from .metrics import checkpoint_rank, checkpoint_score
from .model import RoiPresenceModel
from .sampler import PresenceBalancedBatchSampler
from .validation import load_previous_scores, validate_presence
...
def format_dataset_summary(name: str, dataset: RoiPresenceDataset) -> str:
    return _format_dataset_summary(name, dataset, include_diagnostics=True)
